...
class DecafListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by DecafParser#num.
    def enterNum(self, ctx:DecafParser.NumContext):
        pass

    # Exit a parse tree produced by DecafParser#num.
    def exitNum(self, ctx:DecafParser.NumContext):
        pass
